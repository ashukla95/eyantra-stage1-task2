...
for k in range(1,N_images+1):
        ...
        #your code here
        ### sample route_path and route_length
        route_length = len(route_path)
        print "sddgsfgggggggggggggggggggggggggggg"
        print route_path
        if len(route_path) == 0:
                route_path = [(1,14),(2,13),(1,12),(2,11),(1,10),(2,9),(1,8),(1,7),(1,6),(2,5),(1,4),(1,3),(1,2),(2,1)]
                print "Something is WRONG...!!!!!!!...........Showing sample route....."
                print route_path
        ...
        for i in range(len(route_path)-1):
                ...
                x2 = 50*i2+25
                y2 = 50*j2+25
                cv2.line(img_rgb,(x1,y1),(x2,y2),(255,2,0),3)
